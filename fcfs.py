"""
CMSC 125 MP1
First-come-first-serve CPU scheduler simulator
        ...
        if current_task == None: #NO task currently loaded. Find one.
            ...
            if len(pending_minimum_arr) > 0:
                ...
                for p in pending: #handle start
                    ...
                    if p.arrival_time == pending_minimum and current_task == None:
                        current_task = p
...
if __name__ == '__main__':
    ...
    print("First Come First Serve Scheduling Simulator")
